...
// Runs every 15 minutes during market hours (Mon-Fri, 9 AM - 5 PM ET)
const handler: Handler = async (event: HandlerEvent) => {
  ...
  try {
    ...
    console.log(`[refresh-market-data] Status: ${response.status}, Body: ${body}`);
    ...
    console.error('[refresh-market-data] Error:', message);
