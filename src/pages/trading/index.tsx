          ...
          <div className="rounded-xl border border-gray-200 bg-white p-5 dark:border-zinc-800 dark:bg-zinc-900">
            ...
            <div className="mt-4 space-y-4">
              <label className="block">
                <span className="block text-xs font-semibold uppercase tracking-[0.18em] text-gray-600 dark:text-zinc-300 mb-2">Account size</span>
                <input
                  type="number"
                  min={1000}
                  step={1000}
              ...
              <label className="block">
                <span className="block text-xs font-semibold uppercase tracking-[0.18em] text-gray-600 dark:text-zinc-300 mb-2">Risk per trade (%)</span>
                <input
                  type="number"
                  min={0.25}
                  max={5}
              ...
              <label className="block">
                <span className="block text-xs font-semibold uppercase tracking-[0.18em] text-gray-600 dark:text-zinc-300 mb-2">Max capital allocation (%)</span>
                <input
                  type="number"
                  min={5}
                  max={100}
              ...
              <label className="block">
                <span className="block text-xs font-semibold uppercase tracking-[0.18em] text-gray-600 dark:text-zinc-300 mb-2">Goal horizon (days)</span>
                <input
                  type="number"
                  min={20}
                  max={260}
              ...
              <div>
                <span className="block text-xs font-semibold uppercase tracking-[0.18em] text-gray-600 dark:text-zinc-300 mb-2">Bias</span>
