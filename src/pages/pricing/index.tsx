...
const PLANS: Plan[] = [
  {
    ...
    features: [
      ...
      { text: 'AI Market Advisor', included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'AI Market Advisor', included: false },
      { text: 'LEAPS AI Advisor', included: false },
      { text: 'Priority support', included: false },
    ],
  },
  {
    ...
    monthly: 79,
    annual: 63,
    description: 'Full suite with AI-powered insights',
    cta: 'Start 7-Day Free Trial',
    ctaHref: '/auth/signup?plan=elite',
    color: 'border-amber-500',
    features: [
      { text: 'Everything in Pro', included: true, highlight: true },
      { text: 'AI Market Advisor (daily reports)', included: true, highlight: true },
      { text: 'LEAPS AI Advisor', included: true, highlight: true },
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {[
                  ...
                  { feature: 'AI Market Advisor', free: false, pro: false, elite: true },
                  { feature: 'LEAPS AI Advisor', free: false, pro: false, elite: true },
