...
function CandidatesTable({
  ...
  return (
    <div className="mt-3 rounded-xl border border-gray-200 dark:border-zinc-700/60 overflow-hidden">
      ...
      {/* Legend */}
      <div className="flex flex-wrap gap-4 px-4 py-2.5 bg-gray-50 dark:bg-zinc-900/60 border-t border-gray-200 dark:border-zinc-700/30 text-gray-500 dark:text-zinc-600">
...
function IntentPills({ intent }: { intent: ChatIntent }) {
  return (
    <div className="flex flex-wrap gap-1.5 mt-2 pl-1">
      <span className="text-xs bg-gray-100 dark:bg-zinc-800/80 text-gray-600 dark:text-zinc-400 rounded-full px-2.5 py-0.5 border border-gray-300 dark:border-zinc-700/50">
      ...
      <span className="text-xs bg-gray-100 dark:bg-zinc-800/80 text-gray-600 dark:text-zinc-400 rounded-full px-2.5 py-0.5 border border-gray-300 dark:0 rounded-full px-2.5 py-0.5 border border-gray-300 dark:border-zinc-700/50">
        {intent.timeframe}
      </span>
  ...
  return (
    <Layout>
      ...
      <div className="-m-6 flex flex-col bg-gray-100 dark:bg-zinc-950 overflow-hidden" style={{ height: 'calc(100vh - 4rem)' }}>
        ...
        <div className="flex-shrink-0 border-b border-gray-200 dark:border-zinc-800 bg-white/80 dark:bg-zinc-900/60 backdrop-blur-sm px-5 py-3 flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-gray-500 dark:text-zinc-500 mt-0.5">
              AI-powered scanner · 18 tickers · OpenAI + live Massive.com data
            </p>
          </div>
        ...
        <div className="flex-1 overflow-y-auto px-4 py-5 space-y-5 min-h-0">
                ...
                <div
                  className={`rounded-2xl px-4 py-3 text-sm leading-relaxed ${
                    msg.role === 'user'
                      ...
                      : 'bg-white dark:bg-zinc-800/70 text-gray-800 dark:text-zinc-100 rounded-tl-sm border border-gray-200 dark:border-zinc-700/40 shadow-smd-tl-sm border border-gray-200 dark:border-zinc-700/40 shadow-sm'
                  }`}
                >
                  {msg.content.split('\n').map((line, i, arr) => (
                    <span key={i}>
          ...
          {loading && (
            <div className="flex justify-start">
              ...
              <div className="bg-white dark:bg-zinc-800/70 border border-gray-200 dark:border-zinc-700/40 rounded-2xl rounded-tl-sm shadow-zinc-700/40 rounded-2xl rounded-tl-sm shadow-sm">
                <TypingDots />
              </div>
            </div>
          )}
        ...
        {/* ── Input area ────────────────────────────────────────────────── */}
        <div className="flex-shrink-0 border-t border-gray-200 dark:border-zinc-800 bg-white/90 dark:dark:border-zinc-800 bg-white/90 dark:bg-zinc-900/70 backdrop-blur-sm px-4 py-3">
          {/* Quick-start chips */}
          ...
          <div className="flex gap-2 items-end">
            <textarea
              ...
              disabled={loading}
              rows={1}
              className="flex-1 bg-white dark:bg-zinc-800/80 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-zinc-600 rounded-xl px-4 py-3 text-sm resize-none outline-none border border-gray-300 dark:unded-xl px-4 py-3 text-sm resize-none outline-none border border-gray-300 dark:border-zinc-700 focus:border-indigo-500 transition-colors disabled:opacity-50"
