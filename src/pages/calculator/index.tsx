        ...
        {TABS.map((t) => (
          <button
            ...
            className={`px-4 py-2.5 text-xs font-semibold transition-colors whitespace-nowrap ${
              tab === t.id
                ? 'bg-white dark:bg-zinc-800 border-b-2 border-indigo-500 text-indigo-700 dark:text-indigo-400'
                : 'text-gray-500 dark:text-zinc-400 hover:text-gray-700 dark:hover:text-zinc-200 hover:bg-white dark:hover:bg-zinc-800'
            }`}
          >
            {t.label}
          </button>
    ...
    <Layout title="Options Lab">
      <div className="max-w-5xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          ...
          <div className="rounded-xl border border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-5 shadow-sm flex flex-col justify-between">
            <div>
