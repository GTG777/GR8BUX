        ...
        >
          ...
          <div className={`flex items-center h-16 px-4 border-b border-white/10 ${collapsed ? 'justify-center' : 'justify-between'}`}>
            ...
            <button
              ...
              className={`p-1.5 rounded-lg text-slate-300 hover:bg-white/10 hover:text-white transition-colors ml-auto`}
                  ...
                  {!collapsed && (
                    <button
                      ...
                      className={`w-full flex items-center justify-between px-3 py-1.5 rounded-md text-[11px] font-bold uppercase tracking-wider transition-colors ${
                        anyActive ? 'text-brand-green' : 'text-slate-400 hover:text-white'
                      }`}
                    >
          ...
          <div className="border-t border-white/10 p-2">
            <Link
              href="/profile"
              className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-300 hover:bg-white/10 hover:text-white transition-colors ${
            ...
            <button
              onClick={onSignOut}
              disabled={signingOut}
              className="mt-1 w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-300 hover:bg-red-500/30 hover:text-white transition-colors"
